...
export const createUser = (user: Omit<User, "id">): Promise<Result<User, CreateUserError>> =>
...
export const findUserByEmail = async (email: String): Promise<Result<User, FindUserByEmailError>> => {
  try {
